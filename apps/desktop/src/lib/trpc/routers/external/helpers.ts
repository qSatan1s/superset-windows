...
const WINDOWS_CLI_COMMANDS: Record<ExternalApp, string | null> = {
	...
	iterm: null, // macOS only
	warp: "warp",
	terminal: null, // No universal Windows terminal command
	ghostty: "ghostty",
	sublime: "subl",
	intellij: null, // Multi-edition, uses CLI candidates
	webstorm: "webstorm",
...
/**
 * CLI command candidates for JetBrains IDEs on Windows.
 * JetBrains Toolbox adds idea64, pycharm64, etc. to PATH.
 */
const WINDOWS_CLI_CANDIDATES: Partial<Record<ExternalApp, string[]>> = {
	intellij: ["idea64", "idea", "intellij"],
	pycharm: ["pycharm64", "pycharm", "pycharm64.exe", "pycharm.exe"],
};
